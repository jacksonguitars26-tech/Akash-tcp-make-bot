...
import requests, psutil, jwt, pickle, json, binascii, time, urllib3, base64, datetime, re, socket, threading, ssl, pytz, traceback, signal, multiprocessing, asyncio
from FL4SH_FF import DEcwHisPErMsG_pb2 , MajoRLoGinrEs_pb2 , PorTs_pb2 , MajoRLoGinrEq_pb2 , sQ_pb2 , Team_msg_pb2, RemoveFriend_Req_pb2, GetFriend_Res_pb2, spam_request_pb2, devxt_count_pb2, dev_generator_pb2, kyro_title_pb2, room_join_pb2
...
def load_credentials_from_file(filename="FL4SH_FF.txt"):
    """
    ⚡⚡⚡ DANGER ZONE - CREDENTIAL LOADER ⚡⚡⚡
    """
    try:
        if not os.path.exists(filename):
            print("\033[91;1m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m")
            print("\033[91;1m┃      ❌ SYSTEM HACK FAILED ❌        ┃\033[0m")
            print("\033[91;1m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\033[0m")
            print(f"\033[93;1m┃  📁 FILE MISSING: {filename:<22}┃\033[0m")
            print("\033[91;1m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
        ...
        if not uid or not password:
            print("\033[91;1m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m")
            print("\033[91;1m┃      ⚡ FORMAT ERROR DETECTED ⚡      ┃\033[0m")
            print("\033[91;1m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\033[0m")
            print("\033[93;1m┃  📝 VALID FORMATS:                   ┃\033[0m")
            print("\033[96;1m┃  ⚡ uid=YOUR_UID,password=YOUR_PASS  ┃\033[0m")
            print("\033[96;1m┃  ⚡ uid: YOUR_UID                    ┃\033[0m")
            print("\033[96;1m┃     password: YOUR_PASSWORD          ┃\033[0m")
            print("\033[91;1m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
            return None, None
        
        print("\033[92;1m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m")
        print("\033[92;1m┃    ✅ ACCESS GRANTED - LEVEL 10 ✅   ┃\033[0m")
        print("\033[92;1m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\033[0m")
        print(f"\033[94;1m┃  👤 UID: \033[97;1m{uid:<32}┃\033[0m")
        print(f"\033[94;1m┃  🔑 PASS: \033[97;1m{password:<30}┃\033[0m")
        print("\033[92;1m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
        ...
        print("\033[91;1m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\033[0m")
        print("\033[91;1m┃      💀 CRITICAL ERROR 💀           ┃\033[0m")
        print("\033[91;1m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\033[0m")
        print(f"\033[93;1m┃  ⚡ {str(e):<34}┃\033[0m")
        print("\033[91;1m┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛\033[0m")
        return None, None
...
📱 Player will see:
"FLASH FF wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF] Ꭺᴋᴀꜱʜㅤʙʙź [00FF00]___ Ꭺᴋᴀꜱʜㅤʙʙź____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TIKTOK : @akash_bbz7\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
[C][B][00FFFF]━━━━━━━━━━━
[C][B][FFFFFF]Developer     : AX ROMJAN HOSSAIN 
"""
    # Send main info
...
def get_level_info(player_id):
    url = f"https://flash-level-info.vercel.app/level/{player_id}?key=Flash"
...
def send_guild_info(guild_id):
    ...
    try:
        response = requests.get(
            f"https://danger-guild-management.vercel.app/guild?guild_id={guild_id}&region=ind",
            timeout=15
        )
...
def Get_clan_info(clan_id):
    try:
        url = f"https://danger-guild-management.vercel.app/guild?guild_id={clan_id}&region=ind"
...
def check_ban(uid):
    try:
        url = f"https://flash-ban-check.vercel.app/bancheck?uid={uid}"
        res = requests.get(url, timeout=10)
...
[FFFFFF]ICON        : [FFFFFF]{data.get('icon', 'N/A')}
...
[C][B][11EAFD]‎━━━━━━━━━━━━
[C][B][FFB300]Contact Owner: [FFFFFF] Dm Owner In Telegram [00FF00] @FL4SH_FF  
"""
...
def talk_with_ai(question):
    url = f"https://your-api.vercel.app/ai/ask?key=FLASH_FF&question={question}"
    res = requests.get(url)
    if res.status_code == 200:
        data = res.json()
...
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@FL4SH_FF
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
"""
            ...
            # For example:
            title_packet = await convert_kyro_to_your_system(uid, chat_id, key, iv, nickname="FL4SH_FF", title_id=title_id)
...
async def noob(target_uid, chat_id, key, iv, nickname="FL4SH_FF", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde FLASH FF ya meku agar tu noob bolra toh tu g a y hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="FL4SH_FF", title_id=title_id)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                ...
                if data_hex.startswith("0500") and insquad is None and joining_team == False:
                    try:
                        ...
                        if "FL4SH_FF" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to FLASH FF"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO Ꭺᴋᴀꜱʜㅤʙʙź  BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000] Ꭺᴋᴀꜱʜㅤʙʙź 
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@akash_bbz7
[00FF00]»»————-　★　————-««
[FF0000]█▓▒░░ ENJOY THE BOT! ░░▒▓█"""
                ...
                if senthi == True:
                    ...
                    def get_random_color(): return "_" 
                    message = """[B][C][FF0000]█▓▒░░ WELCOME TO Ꭺᴋᴀꜱʜㅤʙʙź  PREMIUM BOT ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000] Ꭺᴋᴀꜱʜㅤʙʙź 
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@akash_bbz7
...
"""
                                ...
                                credentials = load_credentials_from_file("FL4SH_FF.txt")
                                if not credentials:
...
# GUILD INFORMATION FF
                        ...
                        if inPuTMsG.strip().startswith('/wlremove'):
                            ...
                            # Check owner
                            if str(response.Data.uid) != "3419823759":
...
"""
                            ...
                            if str(response.Data.uid) != "3419823759":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "3419823759":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "3419823759":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {xMsGFixinG(uid)}"
                                    count += 1
                                    if count >= 20:
...
[b][i][FFC0CB]youtube: FLASH FF 99[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @FL4SH_FF[/b]

[b][c][FFA500]telegram contact: @FL4SH_FF[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by Black666FF
Modified by - FL4SH_FF
"""
...
# GLOBAL BLOCKED NAMES
                        BLOCKED_NAMES = ["maruf", "FLASH", "mg-king", "mg_king", "mgking", "mg king"]  # Protected names
                        ...
                        if inPuTMsG.strip().startswith('/gali'):
                            ...
                            try:
                                ...
                                messages = [
                                    "{Name} MSK🤫BWSA",
                                    "{Name} BUMA🤫NOH, KHOI🤫NAI !!",
                                    "{Name} SWI🤫BWSA, PUN🤫BWSA !!",
                                    "{Name} ANI🤫 LWI, CHA FY🤫DI🤫ডম লাগিয়ে চু🤫দি !!",
...
#==================≈===========  /HELP MENU COMMANDS ========================================
                        if inPuTMsG.strip().lower() in ("help", "/help", "menu", "hello", "hi"):
                            ...
                            header = f"[C][B][FF1493]Hey User Welcome To [00FFAA]Ꭺᴋᴀꜱʜㅤʙʙź  PREMIUM BOT"
                            await safe_send_message(response.Data.chat_type, header, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu1 = """[C][B][FFD700]═══⚡COMMAND MENU 1-8⚡═══[FFFFFF][B]
├─ [FFFFFF][FFFFFF]⚡Help Menu 
│  └─ [FF0000]/help
├─ [FFFFFF]Create 3-Player Group
│  └─ [FF0000]/3
├─ [FFFFFF]Create 5-Player Group
│  └─ [FF0000]/5
├─ [FFFFFF]Create 6-Player Group
│  └─ [FF0000]/6
├─ [FFFFFF]Join Bot in Team
│  └─ [FF0000]/join [team_code]
├─ [FFFFFF]Leave Bot Team
│  └─ [FF0000]/exit
├─ [FFFFFF]Kick Player From Team
│  └─ [FF0000]/kick [uid]
└─ [FFFFFF]Start Match 
   └─ [FF0000]/start 
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            ...
                            menu2 = """[C][B][FFD700]═══⚡COMMAND MENU 9-16⚡═══[FFFFFF][B]
├─ [FFFFFF]Send Likes To Account⚡
│  └─ [FF0000]/like [uid]
├─ [FFFFFF]Player Information 
│  └─ [FF0000]/info [uid]
├─ [FFFFFF]Get Player Bio
│  └─ [FF0000]/bio [uid]
├─ [FFFFFF]Account Level Info
│  └─ [FF0000]/level [uid]
├─ [FFFFFF]TikTok Id Info
│  └─ [FF0000]/tt [username]
├─ [FFFFFF]YouTube Channel Info
│  └─ [FF0000]/yt [name]
├─ [FFFFFF]Guild Information 
│  └─ [FF0000]/guild [guild_id]
└─ [FFFFFF]Get Player Status 
   └─ [FF0000]/status [uid]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            await safe_send_message(response.Data.chat_type, menu2, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu3 = """[C][B][FFD700]═══⚡COMMAND MENU 17-24⚡═══[FFFFFF][B]
├─ [FFFFFF]Chat With Ai
│  └─ [FF0000]/ai [question]
├─ [FFFFFF]Account Ban Check 
│  └─ [FF0000]/check [uid]
├─ [FFFFFF]Add Bot In Friend List 
│  └─ [FF0000]/add [uid]
├─ [FFFFFF]Remove From Friend List 
│  └─ [FF0000]/remove [uid]
├─ [FFFFFF]Gali Friend 
│  └─ [FF0000]/gali [name]
├─ [FFFFFF]Direct Message 
│  └─ [FF0000]/dm [uid] [msg]
├─ [FFFFFF]Message Spam 
│  └─ [FF0000]/msg [msg] [repeat]
└─ [FFFFFF]Wave Messages 
   └─ [FF0000]/mg [msg] [repeat]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            await safe_send_message(response.Data.chat_type, menu3, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu4 = """[C][B][FFD700]═══⚡COMMAND MENU 25-32⚡═══[FFFFFF][B]
├─ [FFFFFF]Bundle List
│  └─ [FF0000]/bundle 
├─ [FFFFFF]Set Bundle 
│  └─ [FF0000]/bundle [name]
...
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            ...
                            menu5 = """[C][B][FFD700]═══⚡COMMAND MENU 33-38⚡═══[FFFFFF][B]
├─ [FFFFFF]Bundle Spam 
...
├─ [FFFFFF]Spam Invite 
│  └─ [FF0000]/spm_inv [uid]
├─ [FFFFFF]Spam Friend Requests 
│  └─ [FF0000]/spam_req [uid]
├─ [FFFFFF]Spam Join Requests 
│  └─ [FF0000]/spam_join [uid]
├─ [FFFFFF]Join Req With Badge 'C'
│  └─ [FF0000]/s1 [uid]
├─ [FFFFFF]Join Req With Badge 'V'
│  └─ [FF0000]/s2 [uid]
└─ [FFFFFF]Join Req With Badge 'FF'
   └─ [FF0000]/s3 [uid]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            await safe_send_message(response.Data.chat_type, menu5, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu6 = """[C][B][FFD700]═══⚡COMMAND MENU 39-46⚡═══[FFFFFF][B]
├─ [FFFFFF]Join Req With Badge 'Old V'
│  └─ [FF0000]/s4 [uid]
├─ [FFFFFF]Join Req With Badge 'Pro'
│  └─ [FF0000]/s5 [uid]
├─ [FFFFFF]Bot Speed ⚡⚡⚡
│  └─ [FF0000]/speed
├─ [FFFFFF]Evo Cycle Self 
│  └─ [FF0000]@evos
├─ [FFFFFF]Evo Cycle Player 
│  └─ [FF0000]@evos [uid]
├─ [FFFFFF]Stop Evo Cycle 
│  └─ [FF0000]@sevos
├─ [FFFFFF]Play Emote Self
│  └─ [FF0000]/e [emote]
└─ [FFFFFF]Play Emote Player 
   └─ [FF0000]/e [uid] [emote]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            await safe_send_message(response.Data.chat_type, menu6, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu7 = """[C][B][FFD700]═══⚡COMMAND MENU 47-54⚡═══[FFFFFF][B]
├─ [FFFFFF]Play Emote Without Bot
│  └─ [FF0000]/me [Team Code] [emote]
├─ [FFFFFF]Player Emote Without Bot
│  └─ [FF0000]/me [tc] [uid] [emote]
├─ [FFFFFF]Play Evo Emote 
│  └─ [FF0000]/evo [uid] [1-21]
├─ [FFFFFF]Play Fast Emote 25x
│  └─ [FF0000]/fast [uid] [emote id]
├─ [FFFFFF]Off/Mute Bot (admin)
│  └─ [FF0000]/off
├─ [FFFFFF]On/Unmute Bot (admin)
│  └─ [FF0000]/unmute 
├─ [FFFFFF]Block User (admin)
│  └─ [FF0000]/block [uid]
└─ [FFFFFF]Unblock User (admin)
   └─ [FF0000]/unblock [uid]
[FFFFFF]━━━━━━━━━━━━[FF0000]"""
                            await safe_send_message(response.Data.chat_type, menu7, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu8 = """[C][B][FFD700]═══⚡COMMAND MENU 55-62⚡═══[FFFFFF][B]
├─ [FFFFFF]Good Message To Player 
│  └─ [FF0000]/praisa [name]
├─ [FFFFFF]Send Fake Likes⚡
│  └─ [FF0000]/fake_like [uid]
├─ [FFFFFF]Item Id To Info
│  └─ [FF0000]/item [item_id]
├─ [FFFFFF]Super Calculator 
...
[FFFFFF]Auto Accept Team Invite
[FF0000]Auto Reply 'noob'
[FFFFFF]Auto Play Ring After Join
[FF0000]Auto Ring For Inviter
[FFFFFF]/sticker & /title Work In Only Team Chat
[FF0000]If Any Problems, 
[C][B][FFB300]Contact Owner: [FFFFFF] Dm Owner In Tik Tok [00FF00] @akash_bbz7  
[FFFFFF]━━━━━━━━━━━━"""
                            await safe_send_message(response.Data.chat_type, menu8, uid, chat_id, key, iv)
                            await asyncio.sleep(0.2)

                            menu9 = """[32CD32][B]═══⚡ AUTOMATIC & LOVE ⚡═══
[FFFFFF]প্রিয়,
       লিজা
তোমাকে ভালোবাসি কোনো ব্যাখ্যা নেই 
শুধু জানি মন থেকে ভালোবাসি
আর ভালোবেসে যাবো আজীবন ❤️🥰━━━━━━━━━━━━"""
...
async def MaiiiinE():
    ...
    print("📁 Loading credentials from FL4SH_FF.txt...")
    credentials = load_credentials_from_file("FL4SH_FF.txt")
    
    if not credentials:
        print("❌ Failed to load credentials!")
        print("💡 Please create FL4SH_FF.txt with your UID and password")
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 FL4SH FF BOT - INITIALIZING")
    print("=" * 50)
...
# --- Render-এর জন্য নতুন রান কোড ---

async def render_keep_alive(request):
    return web.Response(text="Bot is running!")

async def run_everything():
    # ১. ওয়েব সার্ভার সেটআপ (Render-এর পোর্ট সমস্যা সমাধানের জন্য)
    app = web.Application()
    app.router.add_get("/", render_keep_alive)
    runner = web.AppRunner(app)
    await runner.setup()
    
    # Render থেকে পোর্ট নেওয়া
    port = int(os.environ.get("PORT", 8080))
    site = web.TCPSite(runner, "0.0.0.0", port)
    await site.start()
    print(f"✅ Render server started on port: {port}")

    # ২. আপনার বটের আসল কাজ শুরু করা
    print("🚀 Starting Bot Tasks...")
    # আপনার ফাইলের আসল মেইন ফাংশন MaiiiinE() কে এখানে কল করা হলো
    await MaiiiinE() 

if __name__ == "__main__":
    try:
        # এটি দিয়ে একসাথে সব চালু হবে
